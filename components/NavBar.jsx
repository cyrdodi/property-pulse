        ...
        <div className="" id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link
              href="/"
              className={`${
                pathname === "/" ? "bg-black" : "hover:bg-gray-800"
              }  hover:text-white text-white block rounded-md px-3 py-2 text-base font-medium`}
            >
              Home
            </Link>
            <Link
              href="/properties"
              className={`${
                pathname === "/properties" ? "bg-black" : "hover:bg-gray-800"
              }  hover:text-white text-white block rounded-md px-3 py-2 text-base font-medium`}
            >
              Properties
            </Link>
